...
<div class="bg-gray-900 px-20 py-20 rounded-lg mb-12 relative overflow-hidden ">
    ...
    <img src="{{ asset('images/dev.png') }}" alt="" class="absolute right-20 -top-20 opacity-30">
</div>
<div class="px-4">
    ...
    <div class="grid grid-cols-1 gap-4 mb-4">
        ...
        <a href="{{ route('post', $post->slug) }}" class="bg-gray-100 rounded-lg px-6 py-4">
            ...
            <div class="text-xs text-gray-900 flex opacity-75 items-center gap-1">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
